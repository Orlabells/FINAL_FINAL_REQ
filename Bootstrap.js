...
//logout button UPDATED                   
                    ...
                    document.getElementById('btnLogout').addEventListener('click', function () {
                        ...
                        showDashboard('loginDashboard');
                    });
// Check if the user is already logged in
const isLoggedIn = localStorage.getItem('isLoggedIn') === 'true';

if (isLoggedIn) {
    // If logged in, show the welcome dashboard and retrieve profile details
    showDashboard('welcomeDashboard');
    displayUserProfile();
} else {
    // If not logged in, show the login dashboard
    showDashboard('loginDashboard');
}
...
// Function to simulate a login by retrieving user details based on email and password
...
// Function to set or update the user profile details in localStorage
function updateProfileDetails(name, email, address, birthdate) {
    const userProfile = {
        name: name,
        email: email,
        address: address,
...
function displayUserProfile() {
    ...
    if (userProfile) {
        ...
        document.getElementById('profilebirthdate').innerText = userProfile.birthdate;
    }
}

// Function to show the specified dashboard
...
document.getElementById('btnLogin').addEventListener('click', function () {
    ...
    const emailInput = document.getElementById('txtLoginEmail').value;
    const passwordInput = document.getElementById('txtLoginPassword').value;
    ...
    const user = getUserByEmailAndPassword(emailInput, passwordInput);

    if (user) {
    // Set or update the user profile details in localStorage
        updateProfileDetails(user.name, user.email, user.address, user.birthdate);
